...
extension Worktree {
  /// Environment variables exposed to all Maestro scripts.
  var scriptEnvironment: [String: String] {
    [
      "MAESTRO_WORKTREE_PATH": workingDirectory.path(percentEncoded: false),
      "MAESTRO_ROOT_PATH": repositoryRootURL.path(percentEncoded: false),
    ]
  }
