  ...
  static let liveValue = TerminalLayoutPersistenceClient(
    loadSnapshot: {
      loadTerminalLayoutSnapshot(
        at: MaestroPaths.terminalLayoutSnapshotURL,
        fileManager: .default
      )
    },
    saveSnapshot: { payload in
      saveTerminalLayoutSnapshot(
        payload,
        at: MaestroPaths.terminalLayoutSnapshotURL,
        cacheDirectory: MaestroPaths.cacheDirectory,
        fileManager: .default
      )
    },
    clearSnapshot: {
      discardTerminalLayoutSnapshot(at: MaestroPaths.terminalLayoutSnapshotURL, fileManager: .default)
    }
  )
