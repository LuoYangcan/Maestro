...
/// row at startup.
///
/// On-disk location: `~/.maestro/repository-appearances.json`. Repos
...
nonisolated enum RepositoryAppearancesFileURLKey: DependencyKey {
  static var liveValue: URL { MaestroPaths.repositoryAppearancesURL }
  static var previewValue: URL { MaestroPaths.repositoryAppearancesURL }
  static var testValue: URL { MaestroPaths.repositoryAppearancesURL }
}
