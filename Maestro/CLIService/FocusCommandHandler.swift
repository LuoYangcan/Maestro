// Maestro/CLIService/FocusCommandHandler.swift
// Handles `maestro focus` by resolving, focusing, and returning final pane context.
...
final class FocusCommandHandler: CommandHandler {
  ...
  func handle(envelope: CommandEnvelope) -> CommandResponse {
    ...
    guard bringToFront() else {
      return errorResponse(code: CLIErrorCode.focusFailed, message: "Failed to bring Maestro to front.")
    }
