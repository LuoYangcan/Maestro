// Maestro/CLIService/OpenCommandHandler.swift
// Handles `maestro open [path]` — resolves path to worktree, selects it, brings app to front.
// Response payload follows doc/contracts/cli/open.md contract.
...
enum OpenResolution: String, Sendable, Codable {
  ...
  /// Path was not yet managed; Maestro opened it as a new root.
...
/// Success payload per doc/contracts/cli/open.md
