...
public enum MaestroSocket {
  ...
  public static let cliOpenPathArgument = "--maestro-cli-open-path"
  ...
  ///
  /// If `MAESTRO_CLI_SOCKET` is set and not empty, it takes precedence.
  ...
  public static var defaultPath: String {
    ...
    return (tmpDir as NSString).appendingPathComponent("maestro-cli.sock")
  }
}
