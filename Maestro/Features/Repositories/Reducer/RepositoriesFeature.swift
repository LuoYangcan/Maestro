...
struct RepositoriesFeature {
  ...
  struct State: Equatable {
    ...
    @Shared(.appStorage("maestroCreatedWorktreeIDs")) var maestroCreatedWorktreeIDs: [Worktree.ID] = []
        ...
        case .autoDeleteExpiredArchivedWorktrees:
          ...
          for entry in expiredEntries {
            ...
            let shouldDeleteBranch =
              ...
              && state.maestroCreatedWorktreeIDs.contains(worktree.id)
  ...
  func confirmationAlertForRepositoryRemoval(
    ...
    return AlertState {
      ...
      TextState(
        "This removes the repository from Maestro. "
