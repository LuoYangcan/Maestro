...
nonisolated enum RepositoryEntriesFileURLKey: DependencyKey {
  static var liveValue: URL { MaestroPaths.repositoryEntriesURL }
  static var previewValue: URL { MaestroPaths.repositoryEntriesURL }
  static var testValue: URL { MaestroPaths.repositoryEntriesURL }
}
