...
nonisolated enum SettingsFileURLKey: DependencyKey {
  static var liveValue: URL { MaestroPaths.settingsURL }
  static var previewValue: URL { MaestroPaths.settingsURL }
  static var testValue: URL { MaestroPaths.settingsURL }
}
