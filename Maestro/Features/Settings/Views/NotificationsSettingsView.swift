...
struct NotificationsSettingsView: View {
  ...
  var body: some View {
    VStack(alignment: .leading) {
      Form {
        Section("Notifications") {
          ...
          .help("Bounce the Maestro app icon in the Dock when a notification is received.")
        }
        Section("System") {
          Toggle(
          ...
          .help("Show the unread worktree count on the Maestro dock icon.")
    ...
    // in System Settings, so the moment Maestro regains focus is when to re-read
  ...
  private var dockBadgeCaption: String? {
    ...
    case .notificationsDenied:
      return "Allow notifications for Maestro in System Settings to show the Dock badge."
    case .badgeDisabled:
      return "Turn on “Badge app icon” for Maestro in System Settings > Notifications."
    }
  }
}
