...
struct WorktreeSettingsView: View {
  ...
  var body: some View {
    ...
    let exampleWorktreePath = MaestroPaths.exampleWorktreePath(
    ...
    VStack(alignment: .leading) {
      Form {
        ...
        Section("Cleanup") {
          VStack(alignment: .leading) {
            Toggle(
              "Preselect branch deletion for Maestro-created worktrees",
              isOn: $store.deleteBranchOnDeleteWorktree
            )
            .help("Preselect local branch deletion for worktrees created by Maestro.")
