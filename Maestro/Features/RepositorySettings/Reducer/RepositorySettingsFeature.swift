...
struct RepositorySettingsFeature {
  ...
  struct State: Equatable {
    ...
    var exampleWorktreePath: String {
      MaestroPaths.exampleWorktreePath(
        for: rootURL,
  ...
  var body: some Reducer<State, Action> {
    ...
    Reduce { state, action in
      ...
      case .settingsLoaded(
        ...
        updatedSettings.worktreeBaseDirectoryPath = MaestroPaths.normalizedWorktreeBaseDirectoryPath(
        ...
        state.globalDefaultWorktreeBaseDirectoryPath =
          MaestroPaths.normalizedWorktreeBaseDirectoryPath(globalDefaultWorktreeBaseDirectoryPath)
      ...
      case .binding:
        ...
        normalizedSettings.worktreeBaseDirectoryPath = MaestroPaths.normalizedWorktreeBaseDirectoryPath(
