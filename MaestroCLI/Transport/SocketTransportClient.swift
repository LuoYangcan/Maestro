// MaestroCLI/Transport/SocketTransportClient.swift
// Unix domain socket client for communicating with running Maestro app.
...
enum SocketTransportClient {
  /// Send a command envelope to the Maestro app and receive a response.
  static func send(_ envelope: CommandEnvelope) throws -> Data {
    ...
    guard connectResult == 0 else {
      throw ExitError(
        ...
        message: "Cannot connect to Maestro. Is the app running?"
      )
    }
