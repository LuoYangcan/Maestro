// MaestroTests/OpenCommandHandlerTests.swift
...
struct OpenCommandHandlerTests {
  ...
  private func makeResolvedTarget(
    worktreeID: String = "Maestro:/Users/test/Projects/Maestro",
    worktreeName: String = "Maestro",
    worktreePath: String = "/Users/test/Projects/Maestro",
    worktreeRootPath: String = "/Users/test/Projects/Maestro",
    worktreeKind: String = "git",
    tabID: String = "0E2A7C03-9C01-4BC1-9327-6C1C7B629A52",
    tabTitle: String = "Maestro 1",
    tabCWD: String? = "/Users/test/Projects/Maestro",
    paneID: String = "0FB4DDB4-A797-4315-A00E-8AAFB32BFC95",
    paneTitle: String = "Maestro",
    paneCWD: String? = "/Users/test/Projects/Maestro"
  ) -> OpenResolvedTarget {
    OpenResolvedTarget(
    ...
    resolveTarget: @escaping OpenCommandHandler.ResolveTargetAction = { selector in
      ...
      case .none:
        return OpenResolvedTarget(
          worktreeID: "Maestro:/Users/test/Projects/Maestro",
          worktreeName: "Maestro",
          worktreePath: "/Users/test/Projects/Maestro",
          worktreeRootPath: "/Users/test/Projects/Maestro",
          worktreeKind: "git",
          tabID: "0E2A7C03-9C01-4BC1-9327-6C1C7B629A52",
          tabTitle: "Maestro 1",
          tabCWD: "/Users/test/Projects/Maestro",
          paneID: "0FB4DDB4-A797-4315-A00E-8AAFB32BFC95",
          paneTitle: "Maestro",
          paneCWD: "/Users/test/Projects/Maestro"
        )
  ...
  @Test func openWithNoPathReturnsBringToFrontAndCurrentTarget() async throws {
    ...
    #expect(response.schemaVersion == "maestro.cli.open.v1")
    ...
    #expect(target.worktree.id == "Maestro:/Users/test/Projects/Maestro")
  ...
  @Test func openWithNoPathDoesNotPollWhenNoTargetExists() async throws {
    ...
    #expect(response.ok == true)
    #expect(sleepCount.value == 0, "Bare maestro must not poll when no target exists")
  }
  ...
  @Test func openExactRootSelectsAndReturnsContractPayload() async throws {
    ...
    let handler = makeHandler(
      resolver: { _ in
        OpenResolverResult(
          ...
          worktreeName: "Maestro",
          worktreePath: "/Users/test/Projects/Maestro",
          rootPath: "/Users/test/Projects/Maestro",
          worktreeKind: "git",
          resolvedPath: "/Users/test/Projects/Maestro"
        )
      },
    ...
    let envelope = CommandEnvelope(
      output: .json,
      command: .open(OpenInput(path: "/Users/test/Projects/Maestro", invocation: "open-subcommand"))
    )
    let response = await handler.handle(envelope: envelope)

    #expect(response.ok == true)
    #expect(selectedID == "Maestro:/Users/test/Projects/Maestro")
    ...
    #expect(payload.requestedPath == "/Users/test/Projects/Maestro")
    #expect(payload.resolvedPath == "/Users/test/Projects/Maestro")
  ...
  @Test func openExactRootCreatesNewTabWhenSelectedWorktreeHasNoVisibleSurface() async throws {
    ...
    let rootPath = "/Users/test/Projects/Maestro"
    ...
    #expect(response.ok == true)
    #expect(selectedID == "Maestro:/Users/test/Projects/Maestro")
    #expect(createdTabFor == "Maestro:/Users/test/Projects/Maestro")
  ...
  @Test func openInsideRootSelectsWorktreeCreatesTabAndKeepsExactTargetCwd() async throws {
    ...
    let subpath = "/Users/test/Projects/Maestro/maestro"
    ...
    #expect(response.ok == true)
    #expect(selectedID == "Maestro:/Users/test/Projects/Maestro")
    #expect(tabCreatedForWorktree == "Maestro:/Users/test/Projects/Maestro")
  ...
  @Test func waitsForRepositoriesReadyBeforeResolvingColdLaunchPath() async throws {
    ...
    let envelope = CommandEnvelope(
      output: .json,
      command: .open(OpenInput(path: "/Users/test/Projects/Maestro", appLaunched: true))
    )
    let response = await handler.handle(envelope: envelope)
