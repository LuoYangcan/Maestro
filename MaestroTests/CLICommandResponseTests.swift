// MaestroTests/CLICommandResponseTests.swift
...
struct CLICommandResponseTests {
  ...
  @Test func successResponseHasStableKeys() throws {
    ...
    #expect(json["schema_version"] as? String == "maestro.cli.list.v1")
  ...
  @Test func errorResponseHasStableKeys() throws {
    ...
    #expect(json["schema_version"] as? String == "maestro.cli.open.v1")
    #expect(json["data"] == nil)
  ...
  @Test func responseRoundTrips() throws {
    ...
    #expect(decoded.schemaVersion == "maestro.cli.send.v1")
