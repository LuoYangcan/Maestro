  ...
  @Test func buildsSchemaConformantListPayloadInStableOrder() async throws {
    let handler = ListCommandHandler {
      ListRuntimeSnapshot(
        ...
        focusedWorktreeID: "Maestro:/Users/onevcat/Projects/Maestro"
      )
    }
    ...
    #expect(response.schemaVersion == "maestro.cli.list.v1")
    ...
    #expect(payload.items[0].worktree.id == "Maestro:/Users/onevcat/Projects/Maestro")
